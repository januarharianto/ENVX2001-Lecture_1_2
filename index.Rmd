...
- Coordinator - Floris van Ogtrop; [floris.vanogtrop@sydney.edu.au](mailto:floris.vanogtrop@sydney.edu.au)
- **Januar Harianto** - Lecturer for Topics 1, 2 & 3
  - [januar.harianto@sydney.edu.au](mailto:januar.harianto@sydney.edu.au)
  - [thomas.bishop@sydney.edu.au](mailto:thomas.bishop@sydney.edu.au)
...
- Ecophysiologist
- Climate Science
- Effects of environmental change on ecosystem and biological responses
...
![:scale 53%](assets/datasampling.png)

Sample and analyse data properly

]

.footnote[Image source: [Instance Selection: The myth behind Data Sampling](https://towardsdatascience.com/instance-selection-the-myth-behind-data-sampling-d3556ea2e37d)]
...
![:scale 30%](assets/scientific_method.jpg)

Design robust experiments

]

.footnote[Image source: [Underwood (1996) Experiments in Ecology, Cambridge University Press](https://www.cambridge.org/core/books/experiments-in-ecology/DCF3663D5E7C9923D19B5ECE88167780)]
...
The latest information about assessments are found in the [Unit outline](https://sydney.edu.au/units/ENVX2001/2020-S1C-ND-CC).

```{r, echo=FALSE, message=FALSE}
read_csv("assets/assessments.csv") %>%
  kable() %>%
...
- [RGuide](https://canvas.sydney.edu.au/courses/14236/pages/help-me-learn-r?module_item_id=409042) by the School of Mathematics and Statistics - *short and sweet*
- [R Module](https://pages.github.sydney.edu.au/januar/rguide_ole_preview/) (under development) - *new to R*
- Lab 1 Session will re-introduce you to R, but try R before coming to the Lab!


.center[![:scale 50%](assets/adventuretime.gif)]
